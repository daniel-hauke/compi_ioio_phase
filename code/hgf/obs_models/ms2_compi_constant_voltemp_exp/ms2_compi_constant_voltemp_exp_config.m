function c = ms2_compi_constant_voltemp_exp_config(ptrans)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
% Model name
c.model = 'ms2_compi_constant_voltemp_exp';
...
% Model filehandle
c.obs_fun = @ms2_compi_constant_voltemp_exp;

% Handle to function that transforms observation parameters to their native space
% from the space they are estimated in
c.transp_obs_fun = @ms2_compi_constant_voltemp_exp_transp;
