function c = ms1_compi_hgf_ar1_lvl3_bo_config
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
% Model name
c.model = 'ms1_compi_hgf_ar1_lvl3_bo';
...
c.prc_fun = @ms1_compi_hgf_ar1_lvl3_bo;

% Handle to function that transforms perceptual parameters to their native space
% from the space they are estimated in
c.transp_prc_fun = @ms1_compi_hgf_ar1_lvl3_bo_transp;
