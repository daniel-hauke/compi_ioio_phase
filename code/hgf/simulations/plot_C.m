function fh = plot_C (C, model_names, plot_title, visibility)
%--------------------------------------------------------------------------
...
set(findall(gcf,'-property','FontSize'),'FontWeight','bold','FontSize',22)
%title(plot_title,'FontWeight','bold','FontSize',20);

xlabel('Inferred model', 'Color','k','FontWeight','bold','FontSize',42)
ylabel('True model', 'Color','k','FontWeight','bold','FontSize',42)
